...
echo Build...
%MSBuildPath%\MSBuild.exe %repositoryPath%\geometry.sln /p:Configuration=Release;VisualStudioVersion=12.0 >msbuild.log
...
echo Running tests...
%NUnitPath%\nunit-console.exe %repositoryPath%\Tests\bin\Release\Tests.dll > tests.txt
